...
Module.register("MMM-WeatherOrNot", {
    ...
    defaults: {
        ...
        dataMode: "", 			// display mode: Current, Forecast or Both ("")
        animationSpeed: 3000,
